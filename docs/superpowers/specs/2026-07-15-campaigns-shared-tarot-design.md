...
- **Challenge:** Counsel, Guardian Angel, Aim, shield Initiative, Stun, black honey, and Brainfever use Challenge hooks.
...
| Challenge modifiers | Counsel, Guardian Angel, Aim, shield Initiative, Stun, black honey, Brainfever, and the GM twist oracle | Typed hooks sharing the Challenge and oracle commands |
